...
while read name health version readonly ashift autoreplace failmode; do
...
while read name type creation mounted mountpoint checksum compression readonly version dedup volblocksize; do
